...
# for linux shell / #!/user/bin/env python3 #
# To build a complex string with component parts use 'format' (or possibly join() #
# flow of execution through a script, without the use of flow control, using branching. #
...
'''going to be asked to unconditionally turn on bits # What does it mean to unconditionally set or clear a bit?
It means that it doesn’t matter what the bit was (0 or 1) prior to the operation.'''
# check the .adoc in the pe folder for help in the exam #
#[<valueExpression> for <controlVariable> in <iterablhttps://www.google.com/e> <whereClause>]#

#Search for the exam at the end#
